    ...
    <>
      <div className="gthh-controller-bar">
        <ul className="gth-controller-view-block">
          <li><Link className={`gth-controller-view-item ${location.pathname === "/followup/order-followup/nothing-bill"
...
export default FollowupPageTopBar