...
function ItemsReceivedDone() {
  ...
  const CustomCell = (props) => {
    ...
    return (
      <td>
        <label className="badge badge-outline-green mb-0"><i className="fas fa-circle f-s-8 d-flex me-1"></i>Items Received Done</label>
        {/* {value} */}
      </td>
    );
  };
        ...
        <Modal.Body><form onSubmit={handleSubmit}>
          ...
          >
            <ReactQuill
              ...
              modules={ItemsReceivedDone.modules}
              formats={ItemsReceivedDone.formats}
              theme="snow"
            // style={{ minHeight: "200px" }}
            />
          </div>
...
export default ItemsReceivedDone;
