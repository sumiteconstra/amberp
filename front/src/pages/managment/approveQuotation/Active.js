  ...
  const CustomCell = (props) => {
    ...
    return (
      <td>
        ...
        <label className="badge badge-outline-active mb-0"><i className="fas fa-circle f-s-8 d-flex me-1"></i>Active</label>
                ...
                <PDFExport data={data} ref={pdfExportRef}>
                  <ExcelExport data={data} ref={excelExportRef} >
                    ...
                    >
                      ...
                      <GridColumn field="expectedArrival" title="expectedArrival" filterable={false} filter="numeric" width="200px" />
                      <GridColumn field="sourceDocument" title="sourceDocument" filterable={false} filter="text" width="200px" />
