...
function PendingApproval() {
  ...
  const CustomCell = (props) => {
    ...
    return (
      <td>
        <label className="badge badge-outline-warning"><i className="fas fa-circle f-s-8 d-flex me-1"></i>Final approval Admin</label>
        ...
        <Modal.Body><form onSubmit={handleSubmit}>
          ...
          >
            <ReactQuill
              ...
              modules={PendingApproval.modules}
              formats={PendingApproval.formats}
              theme="snow"
            // style={{ minHeight: "200px" }}
            />
          </div>
