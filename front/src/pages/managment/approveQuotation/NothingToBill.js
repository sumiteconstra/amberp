                ...
                <PDFExport data={data} ref={pdfExportRef}>
                  <ExcelExport data={data} ref={excelExportRef} >
                    ...
                    >
                      ...
                      <GridColumn field="vendor" title="vendor" filterable={false} filter="tex" width="250px" />
        ...
        <Modal.Body><form onSubmit={handleSubmit}>
          ...
          >
            <ReactQuill
              ...
              modules={NothingToBill.modules}
              formats={NothingToBill.formats}
              theme="snow"
            // style={{ minHeight: "200px" }}
            />
          </div>
