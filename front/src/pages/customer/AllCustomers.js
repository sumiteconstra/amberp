...
function AllCustomers() {
  ...
  const [pageState, setPageState] = useState({ skip: 0, take: 50 });
    ...
    const fetchCustomers = async () => {
      ...
      try {
        const res = await PrivateAxios.get(
          `customer/all-customers?page=${pageState.skip / pageState.take + 1}&pageSize=${pageState.take}`
        );
                            ...
                            <div className="col-lg-3 col-md-4 col-sm-6 col-12">
                              <div className="form-group">
                                ...
                                <div className="custom-select-wrap btn-wrap">
                                  <a
                                    href="https://automybizz.s3.ap-south-1.amazonaws.com/ERP/sample/vendors_full_fields.xlsx"
                                    download='https://automybizz.s3.ap-south-1.amazonaws.com/ERP/sample/vendors_full_fields.xlsx'
                ...
                <div className="">
                  <div className="bg_succes_table_head rounded_table">
                    ...
                    <PDFExport data={data} ref={pdfExportRef}>
                      <ExcelExport data={tableData} ref={excelExportRef}>
                        <Grid
                          data={tableData}
                          skip={pageState.skip}
                          take={pageState.take}
                                ...
                                <img
                                  src={
                                    props.dataItem.attachment_file
                                      ? `${props.dataItem.attachment_file}`
                                      : `https://automybizz.s3.ap-south-1.amazonaws.com/ERP/sample/alert.png`
                                  }
                                  alt="img"
                                  style={{
                                    width: "50px",
