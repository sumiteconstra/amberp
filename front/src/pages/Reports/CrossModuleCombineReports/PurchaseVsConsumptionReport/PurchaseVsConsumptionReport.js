...
import PurchaseConsumptionAnalysisGraph from './PurchaseConsumptionAnalysisGraph';




function PurchaseVsConsumptionReport() {
                ...
                <form onSubmit={handleGenerateReport}>
                    <div className='card'>
                        <div className='card-header'>
                            <h4 className='card-title'>Purchase vs Consumption Report</h4>
                        </div>
                        <div className='card-body pb-1'>
                            <div className='row'>
                                <div className='col-xl-3'>
                                    <div className='form-group'>
                                        <label className="col-form-label">Category <span className="text-exp-red">*</span></label>
                                ...
                                <div className='col-xl-3'>
                                    <div className='form-group'>
                                        <label className="col-form-label">Location <span className="text-exp-red">*</span></label>
                                        <div className="custom-select-wrap">
                                            <Select
                                                isMulti
                                            />
                    ...
                    <div className='card-body p-0 rounded-10'>
                        <div className='row'>
                            <div className='col-lg-12'>
                                <PurchaseConsumptionAnalysisGraph />
                            </div>
                        </div>
                    </div>
                </div>
...
export default PurchaseVsConsumptionReport;