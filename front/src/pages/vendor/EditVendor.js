...
const EditVendor = () => {
  ...
  // Initialize tags state with error handling
  ...
  const fileUpload = async (e) => {
    ...
    if (Number(fileSize) >= 2097152) {
      setError({ file: "This image in greater than 2MB" });
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    PrivateAxiosFile.post(`vendor/update/${id}`, formData1)
      .then((res) => {
        if (res.status === 200) {
      ...
      // .catch((err) => {
      //   ErrorMessage("Error: vendor can only contain alphanumeric characters and spaces.");
  ...
  return (
    <React.Fragment>
      <div className="p-4">
        <div className="mb-4">
          {/* <Link to="/vendors" className="text-dark ">
        ...
        <div className="card">
          <div className="card-header">
            <h3 className="card-title">Update Vendor</h3>
          </div>
              ...
              <div className="row">
                ...
                <div className='col-lg-4 col-md-4 col-sm-6 col-12'>
                  ...
                  <div className='form-group'>
                    ...
                    <input type='text' value={formData.vendor_name} title="Only letters and numbers are allowed" pattern="[A-Za-z0-9 ]*" className="form-control" name='vendor_name' placeholder='Enter vendor Name' onChange={getTaskData} required />
                ...
                <div className='col-lg-4 col-md-4 col-sm-6 col-12'>
                  <div className='form-group'>
                    ...
                    <div className='custom-select-wrap'>
                      <select class="form-select" value={formData.gst_treatment} aria-label="Default select example" name='gst_treatment' onChange={getTaskData} required>
