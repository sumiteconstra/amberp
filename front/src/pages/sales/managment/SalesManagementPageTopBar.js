...
const SalesManagementPageTopBar = () => {
    ...
    <>
      <div className="gthh-controller-bar">
        <ul className="gth-controller-view-block">
          <li><Link className={`gth-controller-view-item ${location.pathname === "/sales/pending-approval/reviewing"
...
export default SalesManagementPageTopBar