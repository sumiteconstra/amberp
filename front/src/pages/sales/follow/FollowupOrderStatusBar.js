                ...
                <div className="d-flex gap-3 px-4 justify-content-between align-items-center">
                    <ul className="top_listing">
                        ...
                        <li className="list_item">
                            <Link to='/sales/followup' className={`listMenu status-activeBg ${location.pathname === "/sales/followup" ? "active" : ""
                                } `}><i className="far fa-dot-circle me-1"></i>Follow Up</Link>
                        </li>
...
export default FollowupOrderStatusBar