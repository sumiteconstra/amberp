                            ...
                            <table className="table table-striped fixedTable-head">
                                <thead>
                                    <tr>
                                        ...
                                        <th><div className="min-width-200 text-end">Amount to Pay</div></th>
                                        <th><div className="min-width-200 text-end">Amount Paid</div></th>
                                        ...
                                        <th><div className="min-width-200 text-end">Balance Amount</div></th>
                                ...
                                <tbody>
                                    ...
                                    {[...Array(5)].map((_, index) => (
                                        <tr key={index}>
                                            ...
                                            <td><div className="min-width-200">Surya Demo Supplier</div></td>
                                            <td>
                                                <div className="min-width-200">
                                                    <button type="button" className="link-btn text-primary fw-medium" onClick={handleShowDocumentDetailsModal}>Invoice</button>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="min-width-200">
                                            ...
                                            <td><div className="min-width-200">13/01/2025</div></td>
                                            <td><div className="min-width-200">28/01/2025</div></td>
                                            <td><div className="min-width-200 text-end">{getGeneralSettingssymbol} 3,650.00</div></td>
                                            <td><div className="min-width-200 text-end">{getGeneralSettingssymbol} 0.00</div></td>
                                            <td><div className="min-width-200 text-end">{getGeneralSettingssymbol} 0.00</div></td>
                                            <td><div className="min-width-200 text-end">{getGeneralSettingssymbol} 0.00</div></td>
                                            <td><div className="min-width-200 text-end">{getGeneralSettingssymbol} 0.00</div></td>
                                            <td><div className="min-width-200 text-end">{getGeneralSettingssymbol} 3,650.00</div></td>
                                            <td><div className="min-width-200">13/01/2025, 10:42 am</div></td>
                                        </tr>
                                    ))}
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><div className="min-width-200">&nbsp;</div></td>
                                        <td><div className="min-width-200">&nbsp;</div></td>
                                        <td><div className="min-width-200 text-end fw-bold f-s-16">{getGeneralSettingssymbol} 3,650.00</div></td>
                                        <td><div className="min-width-200 text-end fw-bold f-s-16">{getGeneralSettingssymbol} 0.00</div></td>
                                        <td><div className="min-width-200 text-end fw-bold f-s-16">{getGeneralSettingssymbol} 0.00</div></td>
                                        <td><div className="min-width-200 text-end fw-bold f-s-16">{getGeneralSettingssymbol} 0.00</div></td>
                                        <td><div className="min-width-200 text-end fw-bold f-s-16">{getGeneralSettingssymbol} 0.00</div></td>
                                        <td><div className="min-width-200 text-end fw-bold f-s-16">{getGeneralSettingssymbol} 3,650.00</div></td>
...
export default DocumentPayable;