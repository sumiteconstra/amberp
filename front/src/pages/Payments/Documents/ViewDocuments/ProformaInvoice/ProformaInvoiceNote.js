...
function ProformaInvoiceNote() {
    ...
    useEffect(() => {
        if (location.pathname === '/document/proforma-invoice-document/create/id') {
                    ...
                    <div className="card-body">
                        ...
                        <div className='row'>
                                        ...
                                        <div className='row'>
                                            <div className='col-md-6'>
                                                <div className='form-group'>
                                                    <div className='w-100'>
                                                        <label className='form-label'>Proforma Invoice Number <span className='text-danger'>*</span></label>
                                            ...
                                            <div className='col-md-6'>
                                                <div className='form-group'>
                                                    ...
                                                    <input type="text" placeholder="Enter Payment Term" className="form-control" />
                                                </div>
                                            </div>
                                            <div className='col-md-6'>
                                                <div className='form-group'>
                            ...
                            <div className='col-xl-5 col-lg-12'>
                                ...
                                <div className='row'>
                                    <div className='col mb-2'>
                                        <div className='text-end fw-medium'>Advance To Pay :</div>
                                    </div>
                                    <div className='col mb-2'>
                                        <div className='text-end d-flex justify-content-end gap-2'>
                                            {getGeneralSettingssymbol}
                                            <div className='w-100 '><input type="text" class="cn_table_input text-end w-100" /></div>
                                        </div>
                                    </div>
                                </div>
...
export default ProformaInvoiceNote