...
function DebitNote() {
    ...
    useEffect(() => {
        if (location.pathname === '/document/dn/create') {
                                ...
                                <div className='row g-3'>
                                    ...
                                    <div className='col-lg-6'>
                                        <div className='card shadow-none border mb-0 h-100'>
                                            ...
                                            <div className='card-body'>
                                                <p className='mb-0 f-s-12 gth-text-dark'><b>Surya Demo Supplier</b></p>
                                                <p className='mb-0 f-s-12 gth-text-dark'>26/3, 30, Nanik Niwas, Dr.D.D Sathe Marg, Near Girgaon Church, Opera House</p>
                                                <p className='mb-0 f-s-12 gth-text-dark'>Mumbai (Maharashtra)</p>
                                                <p className='mb-0 f-s-12 gth-text-dark'>India - 400004</p>
                                                <p className='mb-0 f-s-12 gth-text-dark'><b>GSTIN: 00AACCF0000K0Z0</b></p>
                                                <div className='mt-2 text-end'>
                                                    <button className='btn btn-sm btn-light'>
                                                        <i class="fas fa-map-marker-alt me-2"></i>Place of Supply
                                                    </button>
