...
function TaxInvoiceDocument() {
    ...
    useEffect(() => {
        if (location.pathname === '/document/tax-invoice-document/create/id') {
                                        ...
                                        <div className='row'>
                                            ...
                                            <div className='col-md-6'>
                                                <div className='form-group'>
                                                    ...
                                                    <input type="text" placeholder="Enter Inward Number" className="form-control" />
                                                </div>
                                            </div>
                                            <div className='col-md-6'>
                                                <div className='form-group'>
                                                    <label className='form-label date-label'>Inward Date</label>
                                                    <div className="exp-datepicker-cont">
                                                        <span className="cal-icon"><i className="fas fa-calendar-alt"></i></span>
                                                        <DatePicker
                                                            selected={selectedDate}
                                            ...
                                            <div className='col-md-12'>
                                                <div className='form-group'>
                                                    <div className='w-100'>
                                                        <label className='form-label'>Inward Details</label>
                                                        <div className='custom-select-wrap'>
                                                            <Select
                                                                name="InwardDetails"
                                                                //options={InwardDetails}
                                                                placeholder="Select..."
                                                                //onChange={handleChangeInwardDetails}
                                                            />
                                                        </div>
                                                    </div>
                                                </div>
