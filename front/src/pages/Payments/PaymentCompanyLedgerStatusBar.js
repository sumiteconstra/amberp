...
const PaymentCompanyLedgerStatusBar = () => {
                ...
                <div className="d-flex gap-3 px-4 justify-content-between align-items-center">
                    <ul className="top_listing">
                        <li className="list_item">
                            <Link to='/payment/company-ledger/all' className={`listMenu status-activeBg ${location.pathname === "/payment/company-ledger/all" ? "active" : ""
...
export default PaymentCompanyLedgerStatusBar