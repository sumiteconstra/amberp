...
import PaymentCompanyLedgerStatusBar from "../PaymentCompanyLedgerStatusBar";
import { UserAuth } from "../../auth/Auth";

const CompanyLedgerAll = () => {
                            ...
                            <table className="table table-striped fixedTable-head ">
                                <thead>
                                    <tr>
                                        ...
                                        <th><div className="min-width-150 text-end">Debit</div></th>
                                        <th><div className="min-width-150 text-end">Credit</div></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="min-width-200">
                                                <div className="fw-medium">Invoice</div>
                                            </div>
                                        </td>
                                        <td>
                                            <div className="min-width-200">
                                        ...
                                        <td>
                                            <div className="min-width-150 text-end">
                                                {getGeneralSettingssymbol} 7,500.00
                                            </div>
                                        </td>
                                        <td>
                                            <div className="min-width-150 text-end">
                                    ...
                                    <tr>
                                        ...
                                        <td><div className="min-width-200">Jute Demo Supplier</div></td>
                                        <td>
                                            <div className="min-width-200">
                                                <div className="fw-medium">Invoice</div>
                                            </div>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <div className="min-width-150 text-end fw-bold f-s-16">
                                                {getGeneralSettingssymbol} 7,500.00
                                            </div>
                                        </td>
                                        <td>
...
export default CompanyLedgerAll;