...
const PaymentPaymentsStatusBar = () => {
                ...
                <div className="d-flex gap-3 px-4 justify-content-between align-items-center">
                    <ul className="top_listing">
                        ...
                        <li className="list_item">
                            <Link to='/payment/payments/paid' className={`listMenu status-quotationBg ${location.pathname === "/payment/payments/paid" ? "active" : ""
...
export default PaymentPaymentsStatusBar