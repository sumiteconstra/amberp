...
import PaymentPaymentsStatusBar from "../PaymentPaymentsStatusBar";
import { UserAuth } from "../../auth/Auth";

const PaymentPaymentsPaid = () => {
                            ...
                            <table className="table table-striped fixedTable-head">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="min-width-150">Payment Date</th>
...
export default PaymentPaymentsPaid;