...
function EwayBill() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await PrivateAxios.post("/eaddwaybill", formData);
  ...
  const deleteDepartment = () => {
    setLoading(true)
    PrivateAxios.delete(`edeletewaybill/${deleteId}`)
      .then((res) => {
    ...
    <div className="p-4">
      <div className="card">
        <div className="card-header d-block">
          <h3 className="card-title">E-invoice API account</h3>
          <p className="mb-0">
            Here is the list of your E-invoice API accounts. You can create an E-invoice API account by following these steps, {" "}
            <a
            ...
            <div className="col-12 mt-100 text-center">
              ...
              >
                <Modal.Header closeButton>
                  <Modal.Title>E-invoice API account</Modal.Title>
                </Modal.Header>
                <Modal.Body>
