        ...
        <main className="col-md-12 ms-sm-auto col-lg-12 px-md-4">
          ...
          <div className="row">
            ...
            <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12">
              <div className="card danger-gredient mb-3">
                <div className="card-body">
                  <div className="card-title fs-4">{totalCountdone} Passed</div>
            ...
            <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12">
              <div className="card success-gredient mb-3">
                <div className="card-body">
                  <div className="card-title fs-4">{totalUserscount} Users</div>
            ...
            <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12">
              <div className="card info-gredient mb-3">
                <div className="card-body">
                  <div className="card-title fs-4">{totalUserscountrfq} RFQ</div>
          ...
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-6 col-md-12">
              <div className="card mb-4 shadow-sm">
                <div className="card-header ">
                  <h5 className='card-title'>Yearly  Purchase</h5>
                </div>
                <div className="card-body card-body-height-dashboard">
                  <CustomLineChart />
                </div>
