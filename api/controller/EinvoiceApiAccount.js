const EwayBillAccount = require("../model/EinvoiceApiAccount");

// Create a new E-way Bill API account
exports.eaddEwayBillAccount = async (req, res) => {
  try {
...
exports.eupdateEwayBillAccount = async (req, res) => {
  try {
...
exports.egetAllEwayBillAccounts = async (req, res) => {
  try {
...
exports.edeleteEwayBillAccount = async (req, res) => {
  try {
